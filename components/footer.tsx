      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-300 leading-relaxed max-w-md">
              Tu socio de confianza para encontrar el hogar perfecto. Combinamos
              tecnología de vanguardia con servicio personalizado para hacer tu
              experiencia inmobiliaria perfecta.
            </p>
        ...
        <div className="border-t border-slate-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-400 text-sm">
            © {new Date().getFullYear()} Caribilia. Todos los derechos
            reservados.
          </p>
